...
const NavBar = () => {
  ...
  return (
      ...
      <div className='px-5 main-nav'>
         ...
         <a href=""> <h1 className='my-name font-sign'>Akash</h1></a>
    ...
    <div onClick={() => setToggle(!toggle)} className='cursor-pointer pr-4 z-10 md:hidden nav-toggle'>
       ...
       { toggle && (
                      ...
                      left-0 w-full h-screen bg-black text-4xl text-gray-500'>
                       ...
                       <li 
                       className='py-5 cursor-pointer mobile-li'>
